...
namespace HotelManagement.Models.Ado
{
    public class Hotel
    {
        ...
        public Hotel(int id, string name, int star_number, string cp, int num, string street, string country, string geo_lat, string geo_lon, string phone, string mail, int capacity_rooms, bool swimming_pool, bool driver, bool room_service, string image)
        {
            this.id = id;
            this.name = name;
