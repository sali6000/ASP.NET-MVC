...
namespace HotelManagement.Models.Ado
{
    public class Room
    {
        ...
        public virtual ICollection<RentRoomMember> rent_room_member { get; set; }
        //public string GetImageHotel(int id)
        //{
        //    Repository.RepositoryHotel repository = new Repository.RepositoryHotel();
        //    return repository.SelectHotel(id).image;
        //}
    }
}